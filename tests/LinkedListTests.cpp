...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenPoppingFirst_ThenItemIsRemoved1,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 3, 2, 1 };

  collection.popFirst();

  thenCollectionContainsValues(collection, { 2, 1 });
}

BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenErasingMiddleItem_ThenItemIsRemoved1,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1, 2, 3 };
  ...
  thenCollectionContainsValues(collection, { 1, 3 });
}

BOOST_AUTO_TEST_CASE_TEMPLATE(GivenCollectionWithSingleItem_WhenPoppingLast_ThenCollectionIsEmpty1,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1 };
