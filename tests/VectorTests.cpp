...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenConstIterator_WhenDereferencing_ThenItemIsReturned1,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1, 2, 3 };
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenEmptyCollection_WhenGettingSize_ThenZeroIsReturned1,
                              T,
                              TestedTypes)
{
  const LinearCollection<T> collection;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(GivenNonEmptyCollection_WhenPoppingLast_ThenCollectionSizeIsReduced1,
                              T,
                              TestedTypes)
{
  LinearCollection<T> collection = { 1, 2, 3 };
